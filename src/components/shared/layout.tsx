...
function Header() {
    return (
        <header className='bg-zinc-50 dark:bg-zinc-900 fixed top-0 left-0 w-full z-50'>
            <div className='w-full flex items-center justify-start h-12 mx-auto'>
    ...
    return (
        <footer className='bg-zinc-50 dark:bg-zinc-900 fixed bottom-0 left-0 w-full z-50'>
            <div className='container flex items-center justify-between h-12 mx-auto'>
                ...
                <div className='flex items-center'>
                    <a href='https://github.com/edenilson-souza' target='_blank' rel='noopener noreferrer' className='flex flex-row'>
                        <GitHubIcon />
                        GitHub
                    </a>
                </div>
...
const GitHubIcon = ({ width = 20, height = 20 }) => {
    return (
